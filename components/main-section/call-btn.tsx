...
const CallBtn = () => {
  ...
  const buttonVartiant = {
    initial: { opacity: 0, y: 100 },
    animate: { opacity: 1, y: 0, width: 50, transition: { delay: 0.2 } },
    hover: { width: 300 },
  };
  ...
  return (
    <>
      <motion.div
        className='hidden lg:flex fixed bottom-0 right-0 bg-[var(--mainColor)]  w-[50px] h-[50px] z-50 m-4 rounded-full'
        onMouseEnter={handleMouseEnterControls}
        onMouseLeave={handleMouseLeaveControls}
        variants={buttonVartiant}
        initial='initial'
        animate='animate'
        whileHover='hover'
        whileTap={{ scale: 0.95 }}
      ...
      <motion.div
        className='lg:hidden flexCenter fixed bottom-0 right-0 bg-[var(--mainColor)]  w-[50px] h-[50px] z-50 m-2 rounded-full '
        whileTap={{ scale: 0.95 }}
        onMouseEnter={handleMouseEnterControls}
        onMouseLeave={handleMouseLeaveControls}
        initial={{ opacity: 0, y: 100 }}
