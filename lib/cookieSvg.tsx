...
export const CookieSVG = ({
  ...
  return (
    <svg
      ...
      aria-hidden='true'
      role='img'
      className={`iconify iconify--noto ${width} ${height} `}
      ...
      <g id='SVGRepo_iconCarrier'>
        ...
        <radialGradient
          ...
          <stop offset='.507' stopColor='#f29f58'></stop>
          <stop offset='.715' stopColor='#f09d56'></stop>
          <stop offset='.826' stopColor='#eb9550'></stop>
          <stop offset='.914' stopColor='#e18745'></stop>
          <stop offset='.99' stopColor='#d47436'></stop>
        ...
        <path
          ...
          fill='url(#IconifyId17ecdb2904d178eab6390)'></path>
        <path
